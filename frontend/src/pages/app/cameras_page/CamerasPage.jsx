...
const CamerasPage = () => {
    ...
    const toCameraDetailsPage = (cameraSerialNumber) => {
        navigate(`/app/cameras/${cameraSerialNumber}`);
    };
            ...
            <div className='mx-20'>
                <div className="w-full bg-white p-4 rounded-lg mt-6">
                        ...
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="text-gray-700">
                                {loading ? (
                                    ...
                                    <tr><td colSpan="4" className="text-center py-8">No registered cameras found.</td></tr>
                                ) : (
                                    cameras.map((camera) => (
                                        <tr key={camera._id} className="border-b border-gray-300 hover:bg-gray-50">
                    ...
                    <div className="flex justify-between items-center mt-4 text-sm text-gray-600 px-2">
                        {/* Left side text */}
                        <span>1 - {cameras.length} of {cameras.length}</span>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center font-semibold cursor-pointer">
                                    {cameras.length} <ChevronDown size={16} className="ml-1" />
                                </div>
                            </div>
