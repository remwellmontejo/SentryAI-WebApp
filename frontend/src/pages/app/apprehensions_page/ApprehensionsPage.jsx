...
import { ChevronLeft, ChevronRight, View, ArchiveX, ShieldCheck, Loader } from "lucide-react";
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0">
                            ...
                            >
                                ...
                                <span className="hidden sm:inline whitespace-nowrap">View Resolved</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="hidden sm:inline whitespace-nowrap">View Rejects</span>
                            </button>
                        </div>
                    ...
                    {!loading && (
                        <div className="flex flex-col sm:flex-row justify-between items-center mt-4 text-sm text-gray-600 px-2 gap-4">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex items-center gap-2">
                                    <button onClick={() => setCurrentPage(p => Math.max(1, p - 1))} disabled={currentPage === 1} className="p-1 border border-gray-300 rounded hover:bg-gray-100 disabled:opacity-50 transition-colors">
                                        <ChevronLeft size={18} />
                                    </button>
                                    <span className="font-medium">{currentPage} / {totalPages || 1}</span>
                                    <button onClick={() => setCurrentPage(p => Math.min(totalPages, p + 1))} disabled={currentPage === totalPages || totalPages === 0} className="p-1 border border-gray-300 rounded hover:bg-gray-100 disabled:opacity-50 transition-colors">
